...
// const age = 15;
// let discount = age > 0 && age < 18 ? 10 : (age >= 18 && age <= 65 ? 20 : 30);
// console.log(`Скидка ${discount}%`);
...
// if (username === USER || username === ADMIN && password === RIGHT_PASSWORD) {
...
const weigh = +prompt("Введите вес посылки в килограммах");
const typeOfDelivery = prompt("Укажите тип доставки (Стандарт, Экспресс, Премиум)");
...
if (!(typeOfDelivery === STANDARD || typeOfDelivery === EXPRESS || typeOfDelivery === PREMIUM)) {
...
const baseCost = weigh < 1 ? 5 : (weigh >= 1 && weigh <= 5 ? 10 : 15);
...
const totalCost = baseCost * index;
